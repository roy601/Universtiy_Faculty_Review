...
if (!isset($_GET['faculty_id'])) {
    header("Location: components/faculty.php");
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (mysqli_query($conn, $insert_query)) {
        header("Location: components/my-reviews.php?message=review_added");
        exit();
    } else {
    ...
    <div class="container">
        ...
        <form method="POST" class="review-form">
            ...
            <div class="form-actions">
                ...
                <a href="components/faculty.php" class="btn btn-secondary">Cancel</a>
            </div>
        </form>
    </div>
