    ...
    <nav class="navbar">
        <div class="nav-container">
            ...
            <div class="nav-menu">
                ...
                <a href="components/faculty.php" class="nav-btn"><i class="fas fa-chalkboard-teacher"></i> <span>Faculty</span></a>
                <a href="components/my-reviews.php" class="nav-btn active"><i class="fas fa-star"></i> <span>Reviews</span></a>
    ...
    <div class="container">
        ...
        <?php else: ?>
            <div class="no-reviews">
                ...
                <a href="components/faculty.php" class="btn btn-primary">Browse Faculty</a>
            </div>
        <?php endif; ?>
    </div>
</body>
